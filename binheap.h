// Note: This file was copied from LITMUS^RT, and copyright its original
// author(s).  Originally from:
// https://github.com/LITMUS-RT/litmus-rt/blob/linux-4.9-litmus/include/litmus/binheap.h
